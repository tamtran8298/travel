                            ...
                            {{-- <li class="page-item">
                              ...
                              for($i=0;$i<($count/3);$i++)
                              {
                                ...
                                <li class="page-item active">
                                  <a href="#" class="page-link pageblog" page="{{ $i }}" onclick="callloadblog({{ $i}})" >{{ $i+1 }}</a>
                                </li>
                              <?php }
                              ?>
      ...
      success : function(data){
        ...
        if(data.status ==1){
          ...
          for(var i = 0 ; i < data.data.length ; i++){
           ...
           <a class="d-inline-block singleblog"  href="/single/`+data.data[i].id+`">
